...
-   I learned what PNG magic bytes are and why they are important.
-   I learned that PNG files contain chunks like IHDR, IDAT, and IEND.
-   I learned how to recover missing image metadata using the compressed
    pixel data.
-   I learned how CRC32 protects PNG chunks from corruption.
-   I learned how to repair a damaged PNG using Python and a hex editor.

This challenge was a good introduction to file format analysis and basic
digital forensics.
